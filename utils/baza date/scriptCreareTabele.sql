...
CREATE TABLE NOTE (
	...
	id_materie BIGINT UNSIGNED NOT NULL,
	id_student BIGINT UNSIGNED NOT NULL,
	data_crearii TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	FOREIGN KEY (id_materie) REFERENCES MATERII(id),
	FOREIGN KEY (id_student) REFERENCES STUDENTI(nr_matricol)	
);
/
CREATE TABLE TEME(
	...
	data_incarcarii TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	FOREIGN KEY (id_materie) REFERENCES MATERII(id),
	FOREIGN KEY (id_student) REFERENCES STUDENTI(nr_matricol)	
);
/
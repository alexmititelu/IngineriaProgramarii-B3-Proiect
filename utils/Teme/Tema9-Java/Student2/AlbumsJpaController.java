...
public class AlbumsJpaController implements Serializable {
    ...
    public void create(Albums albums) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findAlbums(albums.getId()) != null) {
    ...
    public void edit(Albums albums) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public Albums findAlbums(BigDecimal id) {
        EntityManager em = getEntityManager();
        try {
